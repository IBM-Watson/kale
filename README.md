...
On Linux, OSX and other Unix-style systems, the `alias` command can be used like this:
    ...
    alias kale="java -jar /full/path/to/kale-1.5.0-standalone.jar"

And on Windows, the `doskey` command can be used like this:

    doskey kale=java -jar C:\full\path\to\kale-1.5.0-standalone.jar $*
...
```
$ alias 'kale=java -jar /Users/ba/Downloads/kale-1.5.0-standalone.jar'
$ kale login
